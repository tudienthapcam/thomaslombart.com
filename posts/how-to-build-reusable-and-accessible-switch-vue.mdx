...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/switch.png"
  alt="A screenshot of a toggle switch"
/>
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/unstyled-switch.png"
  alt="A screenshot of an unstyled toggle switch"
/>
...
The switch is composed of a rounded container element with a circle inside of it. This circle moves to the left or to the right depending on whether the input is checked or not.
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/nonfunctional-switch.png"
  alt="A screenshot of a styled switch but not functional"
/>
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/focus-switch.png"
  alt="A screenshot of a switch with the focus"
/>
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/disabled-switch.png"
  alt="A screenshot of a switch that is disabled"
/>
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/not-responsive-switch.png"
  alt="A screenshot of a switch that is not responsive"
/>
...
<Image
  src="/how-to-build-reusable-and-accessible-switch-vue/responsive-switch.png"
  alt="A screenshot of a switch that is responsive"
/>
