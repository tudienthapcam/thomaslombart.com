...
<Image
  src="/create-a-discord-bot-under-15-minutes/discordjs_website.png"
  alt="Screenshot of Discord.js's website"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/grab-token-1.png"
  alt="Grabbing our token - step 1"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/grab-token-2.png"
  alt="Grabbing our token - step 2"
/>

3. On the left panel, click on ** bot**, then click on **ADD BOT**.

<Image
  src="/create-a-discord-bot-under-15-minutes/grab-token-3.png"
  alt="Grabbing our token - step 3"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/grab-token-4.png"
  alt="Grabbing our token - step 4"
/>

5. After that, you should see a success message telling you _"A wild bot has appeared!"_.

<Image
  src="/create-a-discord-bot-under-15-minutes/grab-token-5.png"
  alt="Grabbing our token - step 5"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/create-server-1.png"
  alt="Create a server - step 1"
/>

2. A popup should appear. Click on **Create a server**.

<Image
  src="/create-a-discord-bot-under-15-minutes/create-server-2.png"
  alt="Create a server - step 2"
/>

3. Fill in the **SERVER NAME** field and choose the **SERVER REGION** depending on your location (the closest, the better).

<Image
  src="/create-a-discord-bot-under-15-minutes/create-server-3.png"
  alt="Create a server - step 3"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/add-bot-server-1.png"
  alt="Add a bot to a server - step 1"
/>

5. Open a new tab and paste in the URL the one you've just copied. Select your server and click on **Authorize**.

<Image
  src="/create-a-discord-bot-under-15-minutes/add-bot-server-2.png"
  alt="Add a bot to a server - step 2"
/>

6. Your bot is added! Go in the Discord app and check for your bot in the list of users.

<Image
  src="/create-a-discord-bot-under-15-minutes/add-bot-server-3.png"
  alt="Add a bot to a server - step 3"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/test-bot-1.png"
  alt="Testing our bot - step 1"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/test-bot-2.png"
  alt="Testing our bot - step 2"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/role-1.png"
  alt="Attributing a role to the bot - step 1"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/role-2.png"
  alt="Attributing a role to the bot - step 2"
/>

3. Click on **Members** on the left side panel, Then click on the rounded + icon next to your bot and add the **bot** role.

<Image
  src="/create-a-discord-bot-under-15-minutes/role-3.png"
  alt="Attributing a role to the bot - step 3"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/heroku_1.png"
  alt="Create new app on heroku - part 1"
/>

3. Give your app a name and click on **Create app**:

<Image
  src="/create-a-discord-bot-under-15-minutes/heroku_2.png"
  alt="Create new app on heroku - part 2"
/>
...
<Image
  src="/create-a-discord-bot-under-15-minutes/heroku_3.png"
  alt="Create new app on heroku - part 3"
/>

6. Finally, switch off the `web` process and switch on the `worker` process:

<Image
  src="/create-a-discord-bot-under-15-minutes/heroku_4.png"
  alt="Create new app on heroku - part 4"
/>
