...
<Image
  src="/boost-workflow-vscode-snippets/command.png"
...
<Image
  src="/boost-workflow-vscode-snippets/list-code.png"
  alt="Selecting a language for the snippet file"
/>
...
<Image
  src="/boost-workflow-vscode-snippets/console.gif"
  alt="GIF showing how to use the console snippet"
/>
...
<Image
  src="/boost-workflow-vscode-snippets/try.gif"
  alt="GIF showing how to use the try snippet"
/>
...
<Image
  src="/boost-workflow-vscode-snippets/warn.gif"
  alt="GIF showing how to use the improved console snippet"
/>
...
<Image
  src="/boost-workflow-vscode-snippets/test.gif"
  alt="GIF showing how to use the test snippet"
/>
