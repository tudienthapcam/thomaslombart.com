...
Communication in a team is vital. I've already written about it in a previous blog post about [soft skills](https://thomlom.dev/soft-skills-developers/). A front-end developer will have to communicate with its colleagues, back-end developers, product owners, managers, and designers! When you go along with a designer and that you truly work together, it can do wonders in your team.
